...
class KeywordTranslator:
    ...
    'FileNotFoundError': 'Datei nicht gefunden Fehler',
    'ZeroDivisionError': 'Nullteilerfehler',
    'OverflowError': 'Überlauf Fehler',
    'ImportError': 'Importfehler',
    'ModuleNotFoundError': 'Modul nicht gefunden Fehler',
    'AttributeError': 'Attributfehler',
    'AssertionError': 'Behauptungsfehler',
    'RuntimeError': 'Laufzeitfehler',
    'StopIteration': 'Iteration stoppen',
